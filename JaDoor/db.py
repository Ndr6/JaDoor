...
if check.fetchone() is None:
    ...
    cursor.execute("CREATE TABLE IF NOT EXISTS exit_list (id text)")
    cursor.execute("INSERT INTO whitelist VALUES ('049ADB0A853280')")
    cursor.execute("INSERT INTO exit_list VALUES ('043FE9CA333580')")
    db.commit()
